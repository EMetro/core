...
class Global {
    config_meta_keys = {
        METRO_INIT: 'init' ,
        METRO_BLUR_IMAGE: 'blur_image' ,
        METRO_GLOBAL_COMMON: 'global_common' ,
        METRO_SHOW_ABOUT: 'about' ,
        METRO_SHOW_COMPILE_TIME: 'compile' ,
        METRO_WEEK_START: 'week_start' ,
        METRO_DATE_FORMAT: 'date_format' ,
        METRO_DATE_FORMAT_INPUT: 'date_format_input' ,
        METRO_LOCALE: 'locale' ,
        METRO_ANIMATION_DURATION: 'animation_duration' ,
        METRO_CALLBACK_TIMEOUT: 'callback_timeout' ,
        METRO_TIMEOUT: 'timeout' ,
        METRO_SCROLL_MULTIPLE: 'scroll_multiple' ,
        METRO_CLOAK_DURATION: 'cloak_duration' ,
        METRO_CLOAK_REMOVE: 'cloak'
    };

    config_keys = {
        METRO_HOTKEYS_FILTER_CONTENT_EDITABLE: true ,
        METRO_HOTKEYS_FILTER_INPUT_ACCEPTING_ELEMENTS: true ,
        METRO_HOTKEYS_FILTER_TEXT_INPUTS: true ,
        METRO_HOTKEYS_BUBBLE_UP: false ,
        METRO_THROWS: true ,
        METRO_DEBUG: true
    };
